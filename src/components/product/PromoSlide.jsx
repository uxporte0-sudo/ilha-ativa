    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-4 md:p-6">
        <div className="max-w-2xl">
          <h2 className="text-lg md:text-2xl lg:text-3xl font-bold text-white leading-tight mb-2">
            {title}
          </h2>
          
          <p className="text-sm md:text-base text-white/90 leading-relaxed mb-4 max-w-md">
            {description}
          </p>
          ...
          {cta && (
            ...
            >
              ...
              <svg 
                ...
                aria-hidden="true"
              >
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4-4 4m-6-8h9a2 2 0 012 2v10a2 2 0 01-2-2V6a2 2 0 012-2z" />
              </svg>
            </a>
          )}
        </div>
